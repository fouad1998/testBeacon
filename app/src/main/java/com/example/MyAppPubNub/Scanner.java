...
public class Scanner extends ScanCallback {
    ...
    Scanner(TextView textView, ImageView imageView) throws Exception {
        ...
        for (int j = 0; j < results.size(); j++) {
            try {
                ...
                if(b.getUuid() == "33963772448957556609" ){
                    myImageView.setImageURI(Uri.parse("https://cdn-a.william-reed.com/var/wrbm_gb_food_pharma/storage/images/2/3/7/0/9310732-1-eng-GB/1NPD%20GALLERY%20(1)_news_large.png"));
                }
            } catch (Exception e) {
